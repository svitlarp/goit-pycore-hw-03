...
print('date1: : ', get_days_from_today(date1)) # -10889
...
# # Test case 3: Dates in wrong format '12-10-2024'. Expected difference: "Bad date format given. The date should be a string in this format: 'YYYY-MM-DD' "
